...
def prepare_valid_bigger_graph():
    G = nx.Graph()
    G.add_node("P:5.0:5.0", label="P", R=1)
    G.add_node("Q:0.0:12.0", label="Q", R=1)
    G.add_node("Q:0.0:-2.0", label="Q", R=1)
    ...
    G.add_edges_from(
        [
            ...
            ("Q:0.0:12.0", "v:0.0:15.0"),
            ("Q:0.0:12.0", "v:-5.0:10.0"),
            ("Q:0.0:12.0", "v:0.0:10.0"),
            ("Q:-5.0:5.0", "v:0.0:10.0"),
            ("Q:-5.0:5.0", "v:-5.0:10.0"),
            ("Q:-5.0:5.0", "v:-5.0:0.0"),
            ("Q:-5.0:5.0", "v:-5.0:0.0"),
            ("Q:-5.0:5.0", "v:0.0:0.0"),
            ("Q:0.0:-2.0", "v:-5.0:0.0"),
            ...
            ("Q:0.0:-2.0", "v:0.0:0.0"),
            # sides
            ("v:-5.0:10.0", "v:0.0:10.0", {"label": "E", "B": 0}),
            ("v:0.0:15.0", "v:10.0:10.0", {"label": "E", "B": 1}),
            ("v:0.0:15.0", "v:-5.0:10.0", {"label": "E", "B": 1}),
            ("v:-5.0:0.0", "v:-5.0:10.0", {"label": "E", "B": 1}),
            ("v:-5.0:0.0", "v:0.0:0.0", {"label": "E", "B": 0}),
            ("v:-5.0:0.0", "v:0.0:-5.0", {"label": "E", "B": 1}),
            ("v:10.0:0.0", "v:0.0:-5.0", {"label": "E", "B": 1}),
        ]
    )
    return G
